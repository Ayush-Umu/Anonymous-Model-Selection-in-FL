...
for noise_multiplier  in noise_multipliers:
    ...
    pickle.dump(global_net.get_parameters(), open("DP fedprox_model_after_{}_rounds_noise_multiplier_{}.p".format(rounds, noise_multiplier), "wb"))
    pickle.dump(history, open("DP fedprox_history_after_{}_rounds_noise_multiplier_{}.p".format(rounds, noise_multiplier), "wb"))
    pickle.dump(test_acc_round, open("DP fedprox_test_accuracy_after_{}_rounds_noise_multiplier_{}.p".format(rounds, noise_multiplier), "wb"))
    pickle.dump(train_acc_round, open("DP fedprox_train_accuracy_after_{}_rounds_noise_multiplier_{}.p".format(rounds, noise_multiplier), "wb"))
