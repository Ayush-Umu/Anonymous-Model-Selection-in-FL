...
for k in ks:
    ...
    """if only_once:
        ...
        only_once = False"""
    #fedavg
    pickle.dump(fedAvg_model.get_parameters(), open("FedProx global Model after {} rounds with k = {}.p".format(rounds, k), "wb"))
    pickle.dump(fedAvg_history, open("FedProx history after {} rounds with k = {}.p".format(rounds, k), "wb"))
    pickle.dump(fedavg_test_acc_round, open("FedProx test accuracy after {} rounds with k = {}.p".format(rounds, k), "wb"))
    pickle.dump(fedavg_train_acc_round, open("FedProx train accuracy after {} rounds with k = {}.p".format(rounds, k), "wb"))
