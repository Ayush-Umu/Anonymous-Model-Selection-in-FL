...
#if only_once:
pickle.dump(global_net.get_parameters(), open("fedavg non-iid Model after {} rounds.p".format(rounds), "wb"))
pickle.dump(history, open("fedavg non-iid history after {} rounds.p".format(rounds), "wb"))
pickle.dump(test_acc_round, open("fedavg non-iid test accuracy after {} rounds.p".format(rounds), "wb"))
pickle.dump(train_acc_round, open("fedavg non-iid train accuracy after {} rounds.p".format(rounds), "wb"))
#only_once = False
"""#fedavg
