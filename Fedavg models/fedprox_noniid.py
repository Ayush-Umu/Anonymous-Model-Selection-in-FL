...
pickle.dump(global_net.get_parameters(), open("fedprox_noniid_model_after_{}_rounds.p".format(rounds), "wb"))
pickle.dump(history, open("fedprox_noniid_history_after_{}_rounds.p".format(rounds), "wb"))
pickle.dump(test_acc_round, open("fedprox_noniid_test_accuracy_after_{}_rounds.p".format(rounds), "wb"))
pickle.dump(train_acc_round, open("fedprox_noniid_train_accuracy_after_{}_rounds.p".format(rounds), "wb"))
