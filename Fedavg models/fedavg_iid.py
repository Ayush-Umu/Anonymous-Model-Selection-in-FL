...
#if only_once:
pickle.dump(global_net.get_parameters(), open("fedavg Model after {} rounds.p".format(rounds), "wb"))
pickle.dump(history, open("fedavg history after {} rounds.p".format(rounds), "wb"))
pickle.dump(test_acc_round, open("fedavg test accuracy after {} rounds.p".format(rounds), "wb"))
pickle.dump(train_acc_round, open("fedavg train accuracy after {} rounds.p".format(rounds), "wb"))
#only_once = False
"""#fedavg
